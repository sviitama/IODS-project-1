...
Dataset "Boston" contains housing values in suburbs of Boston. It is a matrix with 506 rows and 14 columns. Rows are the unnamed suburbs and columns are variables such as crime rate  of pupil-teacher ratio by town.
...
strong negative correlation: dis & age, dis & nox, dis & indus
strong positive correlation: rad & tax, nox & indus, nox & age, tax & indus, rm & medv 
...
The classifier prdicted classes *low* and *high* correctly. For *med_high* there were 5 and for *med_low* even 23 false predictions.
...
Seems like two is a good number of clusters.
