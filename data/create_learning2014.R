...
write.csv(learning2014, "Z:/Jatko-opinnot/IODS/IODS-project-1/data/learning2014.csv", row.names=FALSE)

# See if you can read the data again
learn2014again <- read.csv("Z:/Jatko-opinnot/IODS/IODS-project-1/data/learning2014.csv")
